...
extern "C"
jint Java_com_capsane_prihookmanager_MainActivity_setFromJNI(JNIEnv *env, jobject /* this */, jstring resourceType, jint accessFlag) {
...
extern "C"
jint Java_com_capsane_prihookmanager_MainActivity_getFromJNI(JNIEnv *env, jobject /* this */, jstring resourceType) {
    HelloWorldManager mHelloWorldManager;
    // 将Java String转换为C字符串
    const char *str;
